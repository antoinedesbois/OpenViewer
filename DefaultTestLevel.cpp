...
void DefaultTestLevel::createShaderPrograms()
{
	...
	ShaderProgram* BlinnPhongShaderProgram = new ShaderProgram("./Shaders/BlinnPhong.vs", "./Shaders/BlinnPhong.fg");
	ShaderProgram* SSSProgram = new ShaderProgram("./Shaders/basicPPVS.vs", "./Shaders/SSS.fg");
	ShaderProgram* BumpColorMapsProgram = new ShaderProgram("./Shaders/BumpColorMaps.vs", "./Shaders/BumpColorMaps.fg");
	ShaderProgram* DebugP = new ShaderProgram("./Shaders/Debug.vs", "./Shaders/Debug.fg");
	ShaderProgram* texturedObj = new ShaderProgram("./Shaders/textureObj.vs", "./Shaders/textureObj.fg");
